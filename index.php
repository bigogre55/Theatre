...
if ($sd) {
	echo "<tr>\n";
        echo "\t<td><a href=\"/test/index.php?up=1\"> . . </a></td>\n";
        echo "</tr>\n";
        }
...
//		Do Nothing.
        ...
        echo "<tr>\n";
        echo "\t<td><a href=\"/test/index.php?mov=$i\">$i</a></td>\n";
        echo "</tr>\n";
	} else {
	echo "<tr>\n";
	echo "\t<td><a href=\"/test/index.php?dir=$i\">$i</a></td>\n";
	echo "</tr>\n";
	}
}
?>
